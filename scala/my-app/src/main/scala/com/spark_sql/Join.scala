...
object Join extends App {
  ...
  val employ = Seq((1, "Smith", -1, "2018", "10", "M", 3000),
  ...
  val employColumns = Seq("emp_id", "name", "superior_emp_id", "year_joined", "emp_dept_id", "gender", "salary")

  import spark.sqlContext.implicits._

  val empDF = employ.toDF(employColumns: _*)
